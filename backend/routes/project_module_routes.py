...
from controllers.project_module_controller import create_project_module,get_project_module,update_project_module,delete_project_module,get_project_modules_and_statuses
...
# New route to fetch modules and statuses for a given project
@router.get("/modules/{project_id}/modules-statuses/")
